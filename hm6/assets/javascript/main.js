var athletesArray = ["Kobe Bryant", "Michael Jordan", "David Beckham", "Zinedine Zidane", "Sidney Crosby"];
...
function searchGif(gifName) {
    $.ajax({
            url: 'https://api.giphy.com/v1/gifs/search?q= ' + gifName + ' &api_key=QyR38PtAhzK8olG0li1O5OTaPxje3U9b' ,
            type: 'GET',
